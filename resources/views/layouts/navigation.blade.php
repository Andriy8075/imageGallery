...
@else
    <div class="flex justify-between items-center space-x-4 w-full">
        ...
        <!-- Search Field takes up the remaining space -->
        <div class="flex-1 flex items-center bg-gray-100 rounded-xl px-3 py-2 mx-4">
            ...
            <button class="ml-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="20" height="20">
                    <path fill-rule="evenodd" d="M8.5 3a5.5 5.5 0 110 11 5.5 5.5 0 010-11zm0 1a4.5 4.5 0 100 9 4.5 4.5 0 000-9zm9.146 8.854a1 1 0 00-1.415 0l-3.625 3.625a7.5 7.5 0 111.415-1.415l3.625-3.625a1 1 0 000-1.415z" clip-rule="evenodd"/>
                </svg>
            </button>
        </div>
